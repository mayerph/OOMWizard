...
import { EmailIcon, FacebookIcon, WhatsappIcon, RedditIcon, TwitterIcon } from "react-share";
...
class ShareDialog extends React.Component {
     ...
     */
    platforms = [
        { name : "WhatsApp", source : "https://api.whatsapp.com/send?text=", icon : <WhatsappIcon />}, 
        { name : "Reddit", source : "http://www.reddit.com/submit?url=", icon : <RedditIcon />},
        { name : "Facebook", source : "https://www.facebook.com/sharer/sharer.php?u=", icon : <FacebookIcon />},
        { name : "Twitter", source : "https://api.whatsapp.com/send?text=", icon : <TwitterIcon />},
    ...
    render() {
        ...
        return (
                <Dialog className="social-dialog" onClose={ onClose } aria-labelledby="simple-dialog-title" open={open} fullWidth={true} maxWidth="xs">
                    ...
                    <DialogFooter className="dialog-footer">Choose a share option. The link will open the platform in a new tab.</DialogFooter>
                </Dialog>
        );
    }
}
