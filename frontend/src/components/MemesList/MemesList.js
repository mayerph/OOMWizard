...
//TODO: change state system to Redux and remove the buttons, load data from other components/backend?, add passive information, add interaction for each image
